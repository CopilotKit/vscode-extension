...
describe("hooks integration", () => {
  it("scans the fixture workspace and finds the expected hook sites", () => {
    ...
    expect(hooks).toEqual([
      ...
      { hook: "useFrontendTool", name: "addLocation" },
      { hook: "useFrontendTool", name: "displayAirQuality" },
      { hook: "useFrontendTool", name: "displayCurrentWeather" },
      { hook: "useFrontendTool", name: "displayForecast" },
      { hook: "useFrontendTool", name: "displayHistoricalTemps" },
      { hook: "useFrontendTool", name: "displayPollenReport" },
      { hook: "useFrontendTool", name: "displayPrecipitation" },
      { hook: "useFrontendTool", name: "displayRadar" },
      { hook: "useFrontendTool", name: "displaySevereAlert" },
      { hook: "useFrontendTool", name: "displaySunTimes" },
      { hook: "useFrontendTool", name: "displayWeatherCompact" },
      { hook: "useFrontendTool", name: "publishAlert" },
      { hook: "useFrontendTool", name: "removeLocation" },
  ...
  it("bundles every fixture file without error", async () => {
    for (const fx of [
      ...
      expect(result.success, `${fx}: ${result.error}`).toBe(
        true,
      );
